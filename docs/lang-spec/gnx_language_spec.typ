...
This document lives in the `Atlantix-EDA/grafica-ide` repository under `docs/lang-spec/` — `gnx_language_spec.md` (markdown source) and `gnx_language_spec.typ` (Typst source for the PDF build). Build the PDF with:

```bash
docs/lang-spec/build_gnx_spec.sh
```
