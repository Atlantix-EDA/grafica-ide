//! Tokyo Night Storm palette + egui visuals install.
//!
//! Adopted from CopperForge / zicad with credit. Replaces egui's
//! default brown-tan with a coherent dark surface that reads well
//! against the wgpu-rendered canvas.
...
#[allow(dead_code)] // Palette constants kept available for future use.
impl TokyoNight {
    // Backgrounds
